...
@push('styles')
<style>
body{margin:0;background:linear-gradient(180deg,#fff7ed,#f3ede5);color:#201b17;font-family:"Manrope",sans-serif}.shell{width:min(1160px,calc(100% - 32px));margin:0 auto;padding:28px 0 40px}.top{display:flex;justify-content:space-between;gap:16px;margin-bottom:20px}.brand{display:inline-flex;align-items:center;gap:12px;color:inherit;text-decoration:none;font-weight:800}.brand b{width:42px;height:42px;border-radius:14px;display:inline-flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#f97316,#ef4444);color:#fff;font-family:"Space Grotesk",sans-serif}.card{border:1px solid rgba(63,42,20,.12);border-radius:24px;background:rgba(255,255,255,.82);backdrop-filter:blur(14px);box-shadow:0 18px 60px rgba(63,42,20,.12)}.hero,.panel{padding:24px}.hero h1{margin:0 0 8px;font-family:"Space Grotesk",sans-serif;font-size:clamp(1.9rem,4vw,2.8rem)}.muted,.hero p,.meta,.detail-note,.toolbar-summary{color:#6b6258}.stats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-top:18px}.stat{padding:18px;border-radius:18px;border:1px solid rgba(63,42,20,.08);background:rgba(255,255,255,.68)}.stat strong{display:block;font-size:1.8rem;font-family:"Space Grotesk",sans-serif}.actions{display:flex;gap:12px;flex-wrap:wrap}.btn{display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:0 18px;border-radius:16px;border:0;background:linear-gradient(135deg,#f97316,#ea580c);color:#fff;font:inherit;font-weight:800;cursor:pointer;text-decoration:none}.btn.secondary{background:rgba(255,255,255,.9);color:#201b17;border:1px solid rgba(63,42,20,.12)}.btn.inline{min-height:42px;padding:0 14px}.stack{display:grid;gap:16px;margin-top:20px}.order-card{padding:18px;border-radius:20px;border:1px solid rgba(63,42,20,.08);background:rgba(255,255,255,.68)}.order-head{display:flex;justify-content:space-between;gap:16px;align-items:flex-start;margin-bottom:12px}.order-head strong{font-family:"Space Grotesk",sans-serif;font-size:1.1rem}.badges{display:flex;gap:8px;flex-wrap:wrap}.badge{display:inline-flex;padding:8px 12px;border-radius:999px;background:rgba(249,115,22,.12);color:#9a3412;font-size:13px;font-weight:700}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.empty{padding:20px;border-radius:18px;border:1px dashed rgba(63,42,20,.16);color:#6b6258;text-align:center}.detail-box{margin-top:14px;padding:16px;border-radius:18px;border:1px solid rgba(63,42,20,.08);background:rgba(255,255,255,.8)}.detail-box summary{cursor:pointer;font-weight:800;list-style:none}.detail-box summary::-webkit-details-marker{display:none}.detail-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:14px}.detail-list{display:grid;gap:10px}.detail-item{padding:12px;border-radius:14px;border:1px solid rgba(63,42,20,.08);background:rgba(255,255,255,.7)}.detail-item strong{display:block;margin-bottom:4px}.detail-empty{padding:12px;border-radius:14px;border:1px dashed rgba(63,42,20,.16);color:#6b6258}.toolbar{display:grid;gap:16px;margin-top:20px}.toolbar-row{display:flex;justify-content:space-between;gap:16px;align-items:flex-end;flex-wrap:wrap}.toolbar-form{display:grid;grid-template-columns:minmax(0,1.5fr) minmax(220px,.8fr) auto;gap:12px;flex:1 1 680px}.field{display:grid;gap:8px}.field label{font-size:13px;font-weight:800;color:#6b6258;text-transform:uppercase;letter-spacing:.04em}.field input,.field select{min-height:50px;border-radius:16px;border:1px solid rgba(63,42,20,.12);background:rgba(255,255,255,.94);padding:0 16px;font:inherit;color:#201b17}.field input:focus,.field select:focus{outline:none;border-color:rgba(234,88,12,.4);box-shadow:0 0 0 4px rgba(249,115,22,.12)}.filter-actions{display:flex;gap:10px;align-items:flex-end;flex-wrap:wrap}.chips{display:flex;gap:10px;flex-wrap:wrap}.chip{display:inline-flex;align-items:center;min-height:42px;padding:0 14px;border-radius:999px;border:1px solid rgba(63,42,20,.12);background:rgba(255,255,255,.8);color:#201b17;text-decoration:none;font-weight:700}.chip.active{background:linear-gradient(135deg,#f97316,#ea580c);border-color:transparent;color:#fff}.toolbar-summary strong{color:#201b17}.pill-note{display:inline-flex;align-items:center;gap:8px;padding:10px 14px;border-radius:14px;background:rgba(249,115,22,.08);border:1px solid rgba(249,115,22,.16);font-size:14px}.alert{padding:14px 16px;border-radius:18px;font-size:14px;line-height:1.6}.alert.success{background:rgba(22,163,74,.12);color:#166534}.order-card mark{background:rgba(249,115,22,.18);color:inherit;padding:0 .2em;border-radius:4px}@media (max-width:980px){.stats,.grid,.detail-grid{grid-template-columns:1fr}.order-head,.toolbar-row{flex-direction:column;align-items:stretch}.toolbar-form{grid-template-columns:1fr}.filter-actions{align-items:stretch}.filter-actions .btn{width:100%}}
</style>
@endpush
