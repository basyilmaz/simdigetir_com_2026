...
@push('styles')
<style>
body{margin:0;background:var(--sg-surface-page-light);color:var(--sg-ink-light);font-family:"Manrope",sans-serif}.shell{width:min(1160px,calc(100% - 32px));margin:0 auto;padding:28px 0 40px}.top{display:flex;justify-content:space-between;gap:16px;margin-bottom:20px;align-items:center}.brand{display:inline-flex;align-items:center;gap:12px;color:inherit;text-decoration:none;font-weight:800}.brand b{width:42px;height:42px;border-radius:14px;display:inline-flex;align-items:center;justify-content:center;background:var(--sg-brand-gradient);color:#fff;font-family:"Space Grotesk",sans-serif}.card{border:1px solid var(--sg-border-light);border-radius:24px;background:var(--sg-card-light);backdrop-filter:blur(14px);box-shadow:var(--sg-shadow-light)}.hero,.panel{padding:24px}.hero h1,.section-title{margin:0 0 8px;font-family:"Space Grotesk",sans-serif}.muted,.meta,.detail-note,.hero p{color:var(--sg-muted-light)}.hero-grid,.stats,.detail-grid,.stack,.list{display:grid;gap:14px}.hero-grid,.stats,.detail-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.stat,.info-box,.detail-item,.timeline-item{padding:16px;border-radius:18px;border:1px solid var(--sg-border-light-soft);background:var(--sg-card-light-soft)}.stat strong,.order-no{display:block;font-size:1.8rem;font-family:"Space Grotesk",sans-serif}.badges,.actions{display:flex;gap:12px;flex-wrap:wrap}.badge{display:inline-flex;padding:8px 12px;border-radius:999px;background:var(--sg-accent-warm-bg);color:var(--sg-accent-warm-text);font-size:13px;font-weight:700}.btn{display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:0 18px;border-radius:16px;border:0;background:var(--sg-action-gradient);color:#fff;font:inherit;font-weight:800;cursor:pointer;text-decoration:none}.btn.secondary{background:var(--sg-card-light-strong);color:var(--sg-ink-light);border:1px solid var(--sg-border-light)}.section-title{font-size:1.2rem}.timeline-item strong,.detail-item strong{display:block;margin-bottom:4px}.list{gap:10px}.panel{margin-top:20px}.empty{padding:14px;border-radius:14px;border:1px dashed var(--sg-border-light-dashed);color:var(--sg-muted-light)}.note-box{white-space:pre-line}@media (max-width:980px){.hero-grid,.stats,.detail-grid{grid-template-columns:1fr}.top{flex-direction:column;align-items:flex-start}}
</style>
@endpush
